...
const Navigation = () => {
  ...
  return (
    <header className="header">
      <nav className="bg-gradient-to-r from-cyan to-blue px-4 md:px-6 flex items-center justify-between shadow-md">
        ...
        >
          ...
          <li className="relative inline-block text-white md:mx-4">
            ...
            <ul
              className={`${
                isMenuOpen ? 'block' : 'hidden'
              } md:absolute md:right-0 mt-2 bg-gradient-to-r from-cyan to-blue text-white p-2 rounded-md`}
            >
