              ...
              <div className="flex flex-col justify-between h-full">
                  <div className="p-4">
                      ...
                      <a className="flex items-center text-white space-x-4" >
                          <img src={import logo from '../../assets/Images/logo.svg'} className="w-7 h-7 bg-indigo-600 rounded-lg p-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" /></svg>
