        ...
        <div className="bg-white p-8 rounded-lg shadow-md max-w-3xl w-full flex flex-col sm:flex-row">
          ...
          <div className="w-full sm:w-1/2 pl-0 sm:pl-4">
            <form className="max-w-md" onSubmit={handleSubmit}>
              ...
              <button
                type="submit"
                className="btn-submit w-full py-2 rounded-lg text-white font-bold bg-gradient-to-r from-cyan-600 to-blue-700 hover:opacity-90 transition-colors duration-300"
              >
                Submit
              </button>
            </form>
