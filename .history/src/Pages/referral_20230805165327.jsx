        ...
        <div className="container px-6 py-12 mx-auto">
          ...
          <form className="max-w-lg mx-auto mt-12 p-6 bg-white rounded-lg shadow-md" onSubmit={handleSubmit}>
            <div className="mb-4">
              ...
              <div className="mt-2 flex">
                ...
                <label className="inline-flex items-center mr-4">
                  ...
                  />
                  <span className="ml-2 text-black">Infirmier(ère)</span>
                </label>
                <label className="inline-flex items-center">
                  <input
                    type="radio"
                  ...
                  />
                  <span className="ml-2 text-black">Préposé(e) aux bénéficiaire</span>
                </label>
                <label className="inline-flex items-center">
                  <input
                    type="radio"
                  ...
                  />
                  <span className="ml-2 text-black">Infirmier(ère) auxiliaire</span>
                </label>
                <label className="inline-flex items-center">
                  <input
                    type="radio"
                  ...
                  />
                  <span className="ml-2 text-black">Travailleur(euse) sociale</span>
                </label>
                <label className="inline-flex items-center">
                  <input
                    type="radio"
                  ...
                  />
                  <span className="ml-2 text-black">Technicien(enne) en laboratoire</span>
                </label>
                <label className="inline-flex items-center">
                  <input
                    type="radio"
            ...
            <div className="mb-4">
              ...
              {/* select ,Please Select,Collègue de travail ,Ami(e)*/}
              </div>
            <div className="mb-4 flex">
              <div className="flex-1 mr-2">
                <label className="block text-gray-700 font-semibold mb-2">
