...
const ApplicationForm = () => {
  ...
  const handleSubmit = async (values, { setSubmitting }) => {
    try {
      ...
      // For demonstration purposes, I'm using a fake API call with a delay
      await fakeApiCall(values)
      console.log("""values)

      // Show thank-you message or redirect to a confirmation page
      alert('Form submitted successfully!')
    } catch (error) {
      console.error('Error submitting form:', error)
    } finally {
      // Reset the form and setSubmitting to false after submission is complete
      setSubmitting(false)
    }
  }
