          ...
          {jobsData.map((job, index) => (
            <div key={index} className="p-4 sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/5">
              <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <button className="btn bg-blue-500 text-white px-4 py-2 mt-4 rounded-lg">APPLIQUER</button>
                <button className="bg-gray-300 text-gray-700 px-4 py-2 mt-2 rounded-lg">EN SAVOIR PLUS</button>
              </div>
            </div>
          ))}
        </div>
