...
const index = () => {
  return (
    <section className="hero">
      ...
      <a href="https://twitter.com/PhilseinInc" target="_blank" className="social-icon">
        <FiTwitter />
      </a>
      <a href="https://www.facebook.com/PhilseinInc" target="_blank" className="social-icon">
        <FaFacebookF />
      </a>
      <a href="https://www.instagram.com/philseininc/" target="_blank" className="social-icon">
        <FiInstagram />
      </a>
      <a href="https://www.linkedin.com/company/philsein-inc/" target="_blank" className="social-icon">
        <FiLinkedin />
      </a>
    </div>
       </div>
