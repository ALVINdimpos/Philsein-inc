      ...
      <div className="bg-gray-100 min-h-screen py-8">
        <div className="container mx-auto">
          <h1 className="text-3xl font-bold text-center mb-8">
            Emploi: Technicien(enne) en travail social
          </h1>
          <div className="p-4 bg-white rounded-lg shadow-md">
            <p>
              Vous êtes un technicien en travail social cherchant les meilleures
              perspectives d'emplois au Québec? Vous êtes au bon endroit!
              Défilez pour en savoir plus sur nos postes disponibles en travail
              social!
            </p>
          </div>
          <div className="p-4 bg-white rounded-lg shadow-md mt-8">
            ...
            <p>
              En tant que technicien en travail social, vous jouerez un rôle
              essentiel dans la fourniture de services de soutien aux individus
              et aux familles confrontées à divers défis sociaux. Vous
              travaillerez en étroite collaboration avec les travailleurs
              sociaux et d'autres professionnels de la santé pour évaluer les
              besoins des clients, élaborer des plans de soins et fournir des
              ressources et des services appropriés.
            </p>
          </div>
          <div className="p-4 bg-white rounded-lg shadow-md mt-8">
          ...
          <div className="p-4 bg-white rounded-lg shadow-md mt-8">
            <p>
              ...
              Ceci inclut vos horaires et quarts de travail. Ainsi, dès votre
              embauche, vous pourrez nous indiquer vos préférences d’horaires et
              de quarts. Vous pourrez aussi les modifier par téléphone, ou via
              notre plateforme Employé.
            </p>
          </div>
          <div className="p-4 bg-white rounded-lg shadow-md mt-8">
            <p>
              Un REER Collectif qui rapporte. Nous sommes un fier partenaire du
              fond de solidarité de la FTQ! Un REER au rendement supérieur qui
              vient avec des déductions d’impôt préférentielles!
            </p>
          </div>
        </div>
        ...
        <div className="container mx-auto mt-8">
          ...
          <div className="p-4 bg-white rounded-lg shadow-md">
            ...
            <p>DEC en techniques de travail social</p>
            <p>Portfolio des connaissances récentes : PCI</p>
            <p>Formation sur l’approche Oméga (atout)</p>
            <p>RCR à jour</p>
            <p>Expérience dans le système public (atout)</p>
