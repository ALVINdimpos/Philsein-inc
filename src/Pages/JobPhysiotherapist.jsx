        ...
        <div className="container mx-auto">
          ...
          <div className="p-4 bg-white rounded-lg shadow-md">
            <p>
              ...
              compter parmi notre équipe! Chez Ssein sante, nous sommes
          ...
          <div className="p-4 bg-white rounded-lg shadow-md mt-8">
            ...
            <p>
              En tant que physiothérapeute, vous serez responsable d'évaluer et
              de traiter les patients atteints de douleurs
              musculo-squelettiques, neurologiques et respiratoires. Vous
              travaillerez en étroite collaboration avec d'autres professionnels
              de la santé pour aider les patients à retrouver leur mobilité et
              leur qualité de vie.
            </p>
          </div>
          <div className="p-4 bg-white rounded-lg shadow-md mt-8">
          ...
          <div className="p-4 bg-white rounded-lg shadow-md mt-8">
            ...
            <p>
              Pour le poste de physiothérapeute, nos salaires sont de 65$ à 75$
              de l'heure et varient principalement en fonction de la région
              d’emploi.
            </p>
            <p>
              Ainsi, pour les lieux de travail dans, ou proches des grands
              centres, comme Montréal et Laval, le salaire est de 65$ de
              l’heure.
            </p>
            <p>
              De la même manière, le salaire pour nos emplois en régions plus
              éloignées, comme l’Abitibi et la Côte-Nord, est de 73$ à 75$ de
              l’heure.
            </p>
            <p>
            ...
            <p>
              Les horaires de travail pour ce poste sont à temps plein, du Lundi
              au Vendredi.
            </p>
            <h4 className="text-lg font-bold mt-2">Types de quarts</h4>
            <p>
              Nous vous donnons l'opportunité de choisir entre des quarts de
              jours ou de soir, selon vos préférences.
            </p>
            <p>
              Lieu de travail Au moment de la rédaction de cette offre (Mars
              2023), nos demandes pour physiothérapeutes sont principalement en
              Abitibi et en Côte-Nord. Vous pourrez décider votre région de
              préférence en déposant votre candidature.
            </p>
          </div>
          <div className="p-4 bg-white rounded-lg shadow-md mt-8">
            ...
            <p>
              ...
              régions sélectionnées. Ce programme peut inclure:
            </p>
          ...
          <div className="p-4 bg-white rounded-lg shadow-md mt-8">
            <p>
              Bénéficiez d’horaires de travail flexibles, centrés autour de
              votre style de vie. En fait, dès l’embauche, vous aurez la chance
              de déterminer vos préférences en termes de quarts, d'horaires,
              lieu et même département de travail!
            </p>
          ...
          <div className="container mx-auto mt-8">
            ...
            <div className="p-4 bg-white rounded-lg shadow-md">
              ...
              <p>BAC ou Maîtrise en physiothérapie.</p>
              <p>Être membre de l’Ordre des Physiothérapeutes du Québec.</p>
