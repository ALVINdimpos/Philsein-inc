      ...
      <div className="bg-gray-100 min-h-screen py-8">
        <div className="container mx-auto">
          <h1 className="text-3xl font-bold text-center mb-8">
            Emploi: Travailleur(euse) social(e)
          </h1>
          <div className="p-4 bg-white rounded-lg shadow-md">
            <p>
              Nous avons une offre d’emploi pour les travailleurs(euses) sociaux
              qui veulent développer leur carrière. Vous reconnaissez-vous?
          ...
          <div className="p-4 bg-white rounded-lg shadow-md mt-8">
            ...
            <p>
              En tant que travailleur(euse) social, vous aurez à intervenir
              auprès d’individus, de couples, de familles, de groupes et de
              collectivités en vue de les aider à résoudre ou à prévenir des
              problèmes d’ordre personnel, familial ou social.
            </p>
            <h4 className="text-lg font-bold mt-2">Responsabilité</h4>
            <ul className="list-disc list-inside">
              <li>Évaluer le fonctionnement social du patient</li>
              <li>
                Déterminer un plan d’intervention et en assurer la mise en place
              </li>
              <li>
                Soutenir et rétablir le fonctionnement social du patient en
                tenant compte de son milieu dans le but de favoriser le
                développement optimal de l’être humain.
              </li>
              <li>
                Exercer des activités de conception, d’orientation, de
                consultation, d’actualisation, d’analyse et d’évaluation dans un
                ou plusieurs programmes sociaux
              </li>
            </ul>
          </div>
          <div className="p-4 bg-white rounded-lg shadow-md mt-8">
          ...
          <div className="p-4 bg-white rounded-lg shadow-md mt-8">
            ...
            <p>
              ...
              nos salaires commencent à 68$/h.
            </p>
            ...
            <p>
              Avec nous, vous pourrez décider entre des quarts de jour ou de
              soir. Notre agence vous donne aussi la chance de définir vos
              disponibilités dès le début.
            </p>
            <p>
              Finalement, vous pourrez aussi modifier ces disponibilités au
              courant de votre parcours professionnel avec nous.
            </p>
          </div>
          <div className="p-4 bg-white rounded-lg shadow-md mt-8">
          ...
          <div className="p-4 bg-white rounded-lg shadow-md mt-8">
            <p>Flexibilités</p>
            <p>
              Aillez une plus grande mainmise sur vos conditions de travail!
              Ceci inclu vos horaires et quarts de travail, ainsi que votre
