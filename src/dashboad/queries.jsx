...
export default function queries() {
  ...
  useEffect(() => {
    ...
    axios
      .get('https://cautious-erin-pig.cyclic.app/queries', conf)
      .then((response) => {
  ...
  const handleDelete = (id) => {
    ...
    axios
      .delete(`https://cautious-erin-pig.cyclic.app/queries/${id}`, conf)
      .then((response) => {
            ...
            <tbody className="text-gray-600 text-sm">
              {querries.map((query) => (
                ...
                >
                  ...
                  <td className="py-3 px-6 text-left">{query.last_name}</td>
                  <td className="py-3 px-6 text-center">{query.email}</td>
                  <td className="py-3 px-6 text-center">{query.message}</td>
                  <td className="py-3 px-6 text-center">{query.createdAt}</td>
