        ...
        <div className="flex relative">
            ...
            <div className="flex flex-col justify-between h-full">
              <div className="p-4">
                ...
                <div className="py-4 text-gray-400 space-y-1">
                  ...
                  <Link
                    to="/dashboard"
                    className="py-2.5 px-4 flex items-center space-x-2 bg-gray-800 text-white hover:bg-gray-800 hover:text-white rounded"
                  >
                    <svg
                      className="w-6 h-6"
                      fill="none"
                  ...
                  >
                    ...
                    >
                      ...
                      <g id="SVGRepo_iconCarrier">
                        <path d="M19,20H3V19H2V3H3V2H19V3H20V19H19ZM18,6V4H4V6ZM18,18V8H4V18Z"></path>
                      </g>
                    </svg>
                  ...
                  <Link
                    to=""
                    className="py-2.5 px-4 flex items-center space-x-2 text-white hover:text-white rounded"
                  >
                    <svg
                      fill="currentColor"
                      className="w-6 h-6"
                  ...
                  <div className="relative inline-block">
                    ...
                    >
                      ...
                      >
                        ...
                        <Link
                          to="/dashboard/transport/custom-clearance-services"
                        ...
                        <Link
                          to="/dashboard/transport/cargo-packaging-and-lashing"
                          className="block px-4 py-2 text-gray-700 hover:bg-gray-100"
                          role="menuitem"
                        >
                          Cargo Packaging and Lashing
                        </Link>
                        <Link
                          to="/dashboard/transport/cargo-escort-services"
                          className="block px-4 py-2 text-gray-700 hover:bg-gray-100"
                          role="menuitem"
                        >
                  ...
                  <Link
                    to="/dashboard/transport/queries"
                    className=" py-2.5 px-4 flex items-center space-x-2 bg-gray-800 text-white hover:bg-gray-800 hover:text-white rounded"
                  >
                    <svg
                      className="w-6 h-6"
                  ...
                  <Link
                    to="/dashboard/transport/requested-quote"
                    className=" py-2.5 px-4 flex items-center space-x-2 bg-gray-800 text-white hover:bg-gray-800 hover:text-white rounded"
                  >
                    <svg
                      className="w-6 h-6"
                  ...
                  <Link
                    to="/dashboard/transport/requested-quick-quote"
                    className=" py-2.5 px-4 flex items-center space-x-2 bg-gray-800 text-white hover:bg-gray-800 hover:text-white rounded"
                  >
                    <svg
                      className="w-6 h-6"
          ...
          <main className="flex-1 h-screen overflow-y-scroll overflow-x-hidden">
            <div className="md:hidden justify-between items-center bg-black text-white flex">
              <h1 className="text-2xl font-bold px-4">ssein santé</h1>
