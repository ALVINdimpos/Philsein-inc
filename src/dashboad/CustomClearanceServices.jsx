...
export default function CustomClearanceServices() {
  ...
  useEffect(() => {
    ...
    axios.get('https://kagaba.live/customClearanceService')
      .then((response) => {
  ...
  const handleDelete = (id) => {
    axios.delete(`https://kagaba.live/customClearanceService/${id}`)
      .then((response) => {
  ...
  return (
    <Layout>
      <div className="flex justify-between items-center border-b border-gray-300">
        <h1 className="text-2xl font-semibold pt-2 pb-6">CUSTOMS CLEARANCE SERVICES</h1>
      </div>
      {/* STATISTICS */}
