...
const index = (props) => {
    ...
    useEffect(() => {
      ...
      axios.get('https://cautious-erin-pig.cyclic.app/apps',config)
        .then(response => {
      ...
      // Fetch users
      axios.get('https://cautious-erin-pig.cyclic.app/users',config)
        .then(response => {
      ...
      // Fetch queries
      axios.get('https://cautious-erin-pig.cyclic.app/queries',config)
        .then(response => {
      ...
      // Fetch referrals
      axios.get('https://cautious-erin-pig.cyclic.app/referrals',config)
        .then(response => {
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 py-6">
                <div className="bg-white shadow rounded-sm flex justify-between items-center py-3.5 px-3.5">
                    <div className="space-y-2">
                        ...
                        <div className="flex items-center space-x-2">
                            <h1 className="text-xl font-semibold">{totalApplications}</h1>
                        </div>
                    </div>
                ...
                <div className="bg-white shadow rounded-sm flex justify-between items-center py-3.5 px-3.5">
                    <div className="space-y-2">
                        ...
                        <div className="flex items-center space-x-2">
                            <h1 className="text-xl font-semibold">{totalQueries}</h1>
                        </div>
                    </div>
                ...
                <div className="bg-white shadow rounded-sm flex justify-between items-center py-3.5 px-3.5">
                    <div className="space-y-2">
                        ...
                        <div className="flex items-center space-x-2">
                            <h1 className="text-xl font-semibold">{totalReferrals}</h1>
                        </div>
                    </div>
