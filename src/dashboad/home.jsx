...
const index = (props) => {
  ...
  useEffect(() => {
    ...
    axios
      .get('https://cautious-erin-pig.cyclic.app/apps', config)
      .then((response) => {
    ...
    // Fetch users
    axios
      .get('https://cautious-erin-pig.cyclic.app/users', config)
      .then((response) => {
    ...
    // Fetch queries
    axios
      .get('https://cautious-erin-pig.cyclic.app/queries', config)
      .then((response) => {
    ...
    // Fetch referrals
    axios
      .get('https://cautious-erin-pig.cyclic.app/referrals', config)
      .then((response) => {
