...
export default function referrals() {
  ...
  useEffect(() => {
    const getApps = async () => {
      ...
      const res = await (
        await fetch('https://cautious-erin-pig.cyclic.app/referrals', config)
      ).json()
      setApps((_) => res.data)
  ...
  const DeleteApp = async (deleteApp) => {
    ...
    const res = await (
      await fetch(
        `https://cautious-erin-pig.cyclic.app/referrals/${deleteApp}`,
        {
          method: 'DELETE',
          ...config,
        }
          ...
          <table className="min-w-max w-full table-auto">
            <thead>
              <tr className="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                <th className="py-3 px-6 text-center bg-gray-500 text-white">
                  Referer:
                </th>
              ...
              {apps.length ? (
                apps.map((app, idx) => (
                  ...
                  >
                    ...
                    <td className="py-3 px-6 text-left">{app.referer.email}</td>
