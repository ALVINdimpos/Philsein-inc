  ...
  const data = [
    {
        ...
        location: "Choisissez l'emplacement et le type d'établissement de votre choix! Postes disponibles partout à travers le Québec",
    ...
    },
    {
        ...
        location: "Choisissez l'emplacement et le type d'établissement de votre choix! Postes disponibles partout à travers le Québec.",
        schedule: "Flexibles; possibilité de moduler l'horaire selon ses disponibilités.",
        workingCondition: 'Remplacement ponctuel, court, moyen et long terme à travers le Québec',
    },
    {
